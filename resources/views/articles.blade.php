                        ...
                        <section class="content content-light">
                            <div class="container">
                                ...
                                <div class="docs-content">
                                    ...
                                    <p>2.若有加工管理者，且於加工廠倉處成立原物料倉庫進行存貨管制，則加工廠商應設庫別管理。</p>
                                    ...
                                    <p>「途程」與「製程」之差異說明如下:
                                        假設產出一 PCB Assembly 成品，需經以下五個加工程序，分別是:Axial 橫臥式元件插件、Radiah 直立式元件插件、SMT 元件黏著、過錫及測詴。一個過程為一道製程，經過五道製程可產出一個成品，則五道製程排序後即為一個途程。</p>
